      ...
      <div className="glass-panel w-full max-w-2xl max-h-[90vh] flex flex-col rounded-xl overflow-hidden shadow-2xl border border-white/80 bg-white/95">
        ...
        <div className="p-5 border-b border-slate-200/80 flex justify-between items-center bg-slate-50/70">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600">تخصيص بيانات الورشة، الفواتير، والنسخ الاحتياطي</p>
            </div>
          </div>
          <button
            onClick={onClose}
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full glass-input rounded-lg px-3.5 py-2.5 text-sm appearance-none"
                  >
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200/80 flex flex-col sm:flex-row items-center justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-slate-600 mt-0.5">تنزيل نسخة احتياطية من الطلبيات، المخزون والمصروفات بصيغة JSON</p>
              </div>
              <button
                type="button"
        ...
        <div className="p-4 border-t border-slate-200/80 bg-slate-50/70 flex justify-between items-center">
          {savedSuccess ? (
            ...
            <span className="text-xs text-slate-400 font-mono tabular-nums">الإصدار: v2.4.0 Commercial</span>
          )}
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-xs font-bold rounded-xl text-slate-600 hover:text-slate-800 hover:bg-slate-200/60 transition-all duration-150 ease-out "
            >
              إلغاء
            </button>
            <button
