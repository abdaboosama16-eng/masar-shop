  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 no-print">
        <div>
          <h2 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">المبيعات والطلبيات</h2>
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <button
            ...
            className={`glass-button flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all shadow-xs ${
              isKioskMode 
                ? 'bg-emerald-600 text-white hover:bg-emerald-700 border-emerald-600' 
                : 'text-slate-700 dark:text-slate-200 border-slate-200 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800'
            }`}
            title="تفعيل شاشة عرض الورشة"
            aria-label="تفعيل شاشة عرض الورشة"
          >
            <Tv size={15} className={isKioskMode ? 'text-white' : 'text-emerald-600 dark:text-emerald-400'} />
      ...
      {showSuccessToast && (
        <div className="p-3.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-900 dark:text-emerald-200 flex items-center justify-between animate-in fade-in slide-in-from-top-2 shadow-sm">
          ...
          <button
            ...
            className="text-emerald-700 dark:text-emerald-300 p-1 hover:bg-emerald-500/20 rounded-lg"
          >
            <X size={15} />
          </button>
        </div>
      ...
      <div className="flex items-center gap-2 p-1.5 bg-slate-100/90 dark:bg-slate-800/80 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-xs no-print">
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-xs font-bold transition-all ${
            activeTab === 'new_order'
              ? 'bg-white dark:bg-slate-900 text-emerald-800 dark:text-emerald-300 shadow-sm border border-slate-200/80 dark:border-slate-700'
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-xs font-bold transition-all ${
            activeTab === 'kanban'
              ? 'bg-white dark:bg-slate-900 text-blue-700 dark:text-blue-300 shadow-sm border border-slate-200/80 dark:border-slate-700'
              : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'
          }`}
        >
      ...
      {/* ========================================================================= */}
      {activeTab === 'new_order' && (
        <div className="glass-panel p-6 sm:p-8 rounded-2xl no-print animate-in fade-in duration-200 border border-slate-200/90 dark:border-slate-800 bg-white/95 dark:bg-slate-900/95 shadow-sm space-y-6">
          ...
          <div className="flex items-center justify-between pb-4 border-b border-slate-200/80 dark:border-slate-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-base text-slate-900 dark:text-white">نموذج إضافة طلبية / فاتورة جديدة</h3>
                <p className="text-xs text-slate-500 dark:text-slate-400">إدخال بيانات العقد، الأسعار، وحساب صافي الأرباح وخصم المخزون التلقائي</p>
              </div>
            </div>
            ...
            <button
              type="button"
              onClick={resetForm}
              className="text-xs text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700 transition-colors"
            >
              تفريغ الحقول
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full glass-input rounded-xl px-4 py-2.5 text-sm font-mono font-black text-emerald-800 dark:text-emerald-400 bg-emerald-50/40 dark:bg-emerald-950/20 border-emerald-300/80 dark:border-emerald-700/60"
                    placeholder="#1001"
                  />
                  <span className="absolute left-3 top-2.5 text-[11px] font-bold text-emerald-700 dark:text-emerald-400 bg-emerald-100/70 dark:bg-emerald-900/60 px-2 py-0.5 rounded">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full glass-input rounded-xl px-4 py-2.5 text-sm font-bold text-slate-900 dark:text-white appearance-none bg-white dark:bg-slate-800 cursor-pointer pr-4 pl-10"
                    required
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full glass-input rounded-xl px-4 py-2.5 text-sm font-mono font-bold text-slate-900 dark:text-white"
                  placeholder="0.00"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full glass-input rounded-xl px-4 py-2.5 text-sm resize-y leading-relaxed"
                placeholder="اكتب مواصفات العمل والبنود المتفق عليها..."
              />
            </div>

            {/* Raw Materials Auto-Deduction Section */}
            <div className="p-5 rounded-2xl bg-slate-50/80 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-700 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <PackageMinus size={16} className="text-emerald-600 dark:text-emerald-400" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-2.5 items-center">
                <div className="sm:col-span-7">
                  <select
                    ...
                    className="w-full glass-input rounded-xl px-3 py-2 text-xs bg-white dark:bg-slate-800"
                  >
                ...
                <div className="sm:col-span-3">
                  <input
                    ...
                    placeholder="الكمية..."
                    className="w-full glass-input rounded-xl px-3 py-2 text-xs font-mono bg-white dark:bg-slate-800"
                  />
                </div>
              ...
              {usedMaterials.length > 0 && (
                <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-200 dark:border-slate-700">
                  {usedMaterials.map((mat, idx) => (
                    <div 
                      key={idx}
                      className="flex items-center gap-2 bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-200 dark:border-emerald-800 text-emerald-900 dark:text-emerald-300 px-3 py-1.5 rounded-xl text-xs font-bold"
                    >
                      <Boxes size={13} className="text-emerald-600" />
                      <span>{mat.name}:</span>
                      <span className="font-mono text-emerald-700 dark:text-emerald-400">{mat.quantity} {mat.unit}</span>
                      {mat.totalCost ? (
                        <span className="text-[10px] font-mono text-slate-500 bg-white/80 dark:bg-slate-900/80 px-1.5 py-0.5 rounded">
            ...
            <div className="p-5 rounded-2xl bg-slate-50/90 dark:bg-slate-800/50 border border-slate-200/80 dark:border-slate-700 space-y-3">
              <div className="flex items-center justify-between">
                <label className="block text-xs font-bold text-slate-900 dark:text-white flex items-center gap-1.5">
                  <Calculator size={15} className="text-emerald-700 dark:text-emerald-400" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 items-center">
                <div>
                  <span className="text-[11px] text-slate-500 dark:text-slate-400 block mb-1">تكلفة التنفيذ (المواد والعمالة):</span>
                  <input
                    type="number"
                    min="0"
                    step="0.01"
                    ...
                    className="w-full glass-input rounded-xl px-3 py-2.5 text-sm font-mono font-bold text-rose-700 dark:text-rose-400 bg-white dark:bg-slate-900"
                    placeholder="0.00"
                  />
                </div>

                <div className="p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-center shadow-xs">
                  <span className="text-[11px] text-slate-500 dark:text-slate-400 block mb-0.5">صافي الربح المحسوب آلياً:</span>
                  <span className={`font-mono text-sm font-black ${expectedProfit >= 0 ? 'text-emerald-700 dark:text-emerald-400' : 'text-rose-700 dark:text-rose-400'}`}>
                    {expectedProfit >= 0 ? `+${expectedProfit.toLocaleString()}` : expectedProfit.toLocaleString()} {settings.shopInfo.currency}
                  </span>
                </div>

                <div className="p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-center shadow-xs">
                  <span className="text-[11px] text-slate-500 dark:text-slate-400 block mb-0.5">نسبة هامش الربح:</span>
            ...
            <div className="pt-3 border-t border-slate-200/80 dark:border-slate-800">
              <button
                ...
                className="text-xs font-bold text-slate-700 dark:text-slate-300 hover:text-emerald-700 dark:hover:text-emerald-400 flex items-center gap-1.5 py-1 transition-colors"
              >
              ...
              {showAdvancedFields && (
                <div className="mt-3 p-5 rounded-2xl bg-slate-50/80 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-700 space-y-4 animate-in fade-in">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
                    ...
                    <div>
                      <label className="block text-[11px] font-bold text-slate-600 dark:text-slate-400 mb-1">العربون المدفوع ({settings.shopInfo.currency})</label>
                      <input
                        type="number"
                        min="0"
                        value={deposit}
                    ...
                    <div>
                      <label className="block text-[11px] font-bold text-slate-600 dark:text-slate-400 mb-1">المتبقي للتحصيل</label>
                      <div className="w-full px-3 py-2 text-xs font-mono font-bold bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-800 dark:text-slate-200">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                    <div>
                      <label className="block text-[11px] font-bold text-slate-600 dark:text-slate-400 mb-1">تاريخ التسليم المستهدف</label>
                      <input
                        type="date"
                    ...
                    <div>
                      <label className="block text-[11px] font-bold text-slate-600 dark:text-slate-400 mb-1">عنوان موقع التركيب</label>
                      <input
                        type="text"
                  ...
                  {serviceType === 'لافتة إعلانية' && (
                    <div className="pt-3 border-t border-slate-200/80 dark:border-slate-700 space-y-3">
                      <span className="text-[11px] font-bold text-emerald-800 dark:text-emerald-400 block">مقاسات اللوحة والرافعة:</span>
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 items-center">
                        <div>
                          <label className="block text-[10px] text-slate-500 dark:text-slate-400 mb-1">الطول (متر)</label>
                          <input
                            type="number"
                            step="0.01"
                            value={height}
                            onChange={(e) => setHeight(e.target.value)}
                            className="w-full glass-input rounded-xl px-3 py-1.5 text-xs font-mono bg-white dark:bg-slate-800"
                            placeholder="2.0"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] text-slate-500 dark:text-slate-400 mb-1">العرض (متر)</label>
                          <input
                            type="number"
                            step="0.01"
                            value={width}
                        ...
                        <div>
                          <label className="block text-[10px] text-slate-500 dark:text-slate-400 mb-1">تكلفة الرافعة والنقل ({settings.shopInfo.currency})</label>
                          <input
                            type="number"
                            min="0"
                            value={craneCost}
                      ...
                      {width && height && (
                        <div className="text-[11px] font-bold text-emerald-800 dark:text-emerald-300 bg-emerald-50 dark:bg-emerald-950/40 px-3 py-1.5 rounded-lg border border-emerald-200 dark:border-emerald-800 flex justify-between items-center">
                          <span>المساحة المحسوبة آلياً:</span>
                          <span className="font-mono">{calculatedArea} متر مربع (م²)</span>
                        </div>
                      )}
                    </div>
                  )}
        ...
        <div className="space-y-5 animate-in fade-in duration-200">
          ...
          {!isKioskMode && (
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 no-print">
              <div className="glass-panel p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white/90 dark:bg-slate-900/80">
                <span className="text-[11px] font-bold text-slate-500 dark:text-slate-400 block mb-1">إجمالي المبيعات</span>
              ...
              <div className="glass-panel p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white/90 dark:bg-slate-900/80">
                <span className="text-[11px] font-bold text-slate-500 dark:text-slate-400 block mb-1">إجمالي التكاليف</span>
                <span className="font-mono text-lg font-black text-rose-700 dark:text-rose-400">
                  {totalCosts.toLocaleString()} {settings.shopInfo.currency}
                </span>
              </div>
              <div className="glass-panel p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white/90 dark:bg-slate-900/80">
                <span className="text-[11px] font-bold text-slate-500 dark:text-slate-400 block mb-1">صافي الأرباح</span>
              ...
              <div className="glass-panel p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white/90 dark:bg-slate-900/80">
                <span className="text-[11px] font-bold text-slate-500 dark:text-slate-400 block mb-1">عدد الطلبيات</span>
                <span className="font-mono text-lg font-black text-slate-900 dark:text-white">
                  {orders.length} طلبية
                </span>
              </div>
          ...
          <div className="glass-panel p-4 sm:p-5 rounded-2xl no-print space-y-4 bg-white/90 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800 shadow-xs">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 pb-3 border-b border-slate-200/70 dark:border-slate-800">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-400 flex items-center justify-center font-bold">
                  <BookOpen size={16} />
                </div>
                <div>
                  <h3 className="font-bold text-sm text-slate-900 dark:text-white">كشف حسابات الزبائن وتصفية السجل</h3>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400">تصفية الفواتير بحسب اسم الزبون ومراجعة إجمالي المسدد والمتبقي</p>
                </div>
              </div>

              {/* Client Selector Dropdown */}
              <div className="flex items-center gap-2 w-full md:w-auto">
                <span className="text-xs font-bold text-slate-600 dark:text-slate-300 shrink-0">اختيار الزبون:</span>
                <div className="relative flex-1 md:w-64">
                  <select
                    value={selectedClientFilter}
                    onChange={(e) => setSelectedClientFilter(e.target.value)}
                    className="w-full glass-input rounded-xl px-3 py-2 text-xs font-bold text-slate-900 dark:text-white appearance-none bg-white dark:bg-slate-800 cursor-pointer pr-3 pl-8"
                  >
            ...
            {selectedClientFilter !== 'الكل' && (
              <div className="p-4 rounded-xl bg-indigo-50/70 dark:bg-indigo-950/40 border border-indigo-200/80 dark:border-indigo-800/60 animate-in fade-in">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3">
                  <div className="flex items-center gap-2">
                    <User size={16} className="text-indigo-700 dark:text-indigo-400" />
                    <span className="text-xs font-black text-indigo-950 dark:text-indigo-200">
                      كشف حساب: {selectedClientFilter}
                    </span>
                  </div>
                  <span className="text-[11px] font-bold text-indigo-700 dark:text-indigo-300 bg-indigo-100/80 dark:bg-indigo-900/60 px-2.5 py-0.5 rounded-lg">
                    عدد الفواتير: {clientLedgerStats.count}
                  </span>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-indigo-100 dark:border-indigo-900/50 shadow-xs">
                    <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 block mb-1">إجمالي الفواتير المطلوبة</span>
                  ...
                  <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-emerald-200/80 dark:border-emerald-900/50 shadow-xs">
                    <span className="text-[10px] font-bold text-emerald-800 dark:text-emerald-400 block mb-1">إجمالي المدفوع (المسدد)</span>
                  ...
                  <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-rose-200/80 dark:border-rose-900/50 shadow-xs">
                    <span className="text-[10px] font-bold text-rose-700 dark:text-rose-400 block mb-1">إجمالي المتبقي للتحصيل</span>
                    <span className="font-mono text-base font-black text-rose-700 dark:text-rose-400">
            ...
            <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-3 pt-1">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full glass-input rounded-xl pr-10 pl-4 py-2.5 text-xs bg-slate-50/70 dark:bg-slate-800/70"
                />
                {searchTerm && (
                  <button 
                    type="button"
              ...
              <div className="flex items-center gap-1.5 overflow-x-auto pb-1 md:pb-0 text-xs">
                {['الكل', 'لافتة إعلانية', 'إدارة صفحات سوشيال ميديا', 'تصميم موقع إلكتروني', 'خدمات طباعة'].map((tab) => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-xl font-bold whitespace-nowrap transition-all text-xs border ${
                      selectedServiceFilter === tab
                        ? 'bg-slate-900 text-white border-slate-900 dark:bg-emerald-700 dark:border-emerald-600 shadow-xs'
          ...
          <div className={isKioskMode ? "grid grid-cols-1 lg:grid-cols-2 gap-5 no-print" : "space-y-3.5 no-print"}>
            {filteredOrders.map((order) => {
              ...
              return (
                <div 
                  key={order.id} 
                  className={`glass-panel p-5 rounded-2xl flex flex-col justify-between gap-4 hover:shadow-md transition-all duration-200 border border-slate-200/80 dark:border-slate-800 bg-white/95 dark:bg-slate-900/90 ${
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between gap-3 mb-2">
                      <div className="flex flex-wrap items-center gap-2 min-w-0">
                        ...
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-bold bg-slate-100 dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 text-slate-800 dark:text-slate-200">
                          {renderServiceIcon(order.serviceType)}
                          <span>{order.serviceType || 'لافتة إعلانية'}</span>
                        </span>

                        <h3 className={`font-black text-slate-900 dark:text-white truncate ${isKioskMode ? 'text-lg' : 'text-base'}`}>
                          {order.clientName}
                        </h3>
                      </div>
                      ...
                      <div className="relative shrink-0">
                        <select
                          ...
                          className={`rounded-xl px-3 py-1.5 text-xs font-black border appearance-none text-center cursor-pointer transition-all pr-7 pl-3.5 shadow-xs
                            ${order.status === 'تم التسليم' ? 'text-emerald-800 dark:text-emerald-300 bg-emerald-100/90 dark:bg-emerald-950/70 border-emerald-300 dark:border-emerald-700' : 
                              order.status === 'قيد التركيب' ? 'text-blue-800 dark:text-blue-300 bg-blue-100/90 dark:bg-blue-950/70 border-blue-300 dark:border-blue-700' : 
                              order.status === 'بانتظار اعتماد التصميم' ? 'text-purple-800 dark:text-purple-300 bg-purple-100/90 dark:bg-purple-950/70 border-purple-300 dark:border-purple-700' :
                              'text-amber-800 dark:text-amber-300 bg-amber-100/90 dark:bg-amber-950/70 border-amber-300 dark:border-amber-700'}`}
                        >
                    ...
                    {/* Description */}
                    <p className={`text-slate-600 dark:text-slate-300 mb-3 font-normal leading-relaxed ${isKioskMode ? 'text-sm font-medium' : 'text-xs line-clamp-2'}`}>
                      {order.description}
                    </p>

                    {/* Badges / Specs Row */}
                    <div className="flex flex-wrap items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
                      <span className="bg-slate-100 dark:bg-slate-800 px-2.5 py-1 rounded-lg text-[11px] font-medium">
                      ...
                      {order.assignedEmployee && (
                        <span className="bg-blue-50 dark:bg-blue-950/50 text-blue-800 dark:text-blue-300 border border-blue-200/80 dark:border-blue-800 px-2.5 py-1 rounded-lg text-[11px] font-bold">
                          المسؤول: {order.assignedEmployee}
                        </span>
                      )}

                      {order.dimensions?.width && order.dimensions?.height && (
                        <span className="flex items-center text-slate-800 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-2.5 py-1 rounded-lg font-mono text-[11px] font-bold">
                          <Maximize size={12} className="ml-1 text-slate-500" />
                      ...
                      {order.installationAddress && (
                        <span className="flex items-center text-slate-800 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-2.5 py-1 rounded-lg text-[11px]">
                          <MapPin size={12} className="ml-1 text-slate-500" />
                          {order.installationAddress}
                        </span>
                      )}

                      {order.targetDeliveryDate && (
                        <span className="flex items-center bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-2.5 py-1 rounded-lg text-[11px] font-bold text-slate-700 dark:text-slate-300">
                  ...
                  <div className="flex items-center gap-4 bg-slate-50/90 dark:bg-slate-800/80 p-3.5 rounded-xl border border-slate-200/80 dark:border-slate-700 shrink-0">
                    <div className="text-right">
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 block font-bold">سعر الفاتورة:</span>
                    ...
                    {/* Cost & Profit */}
                    <div className="text-right">
                      <span className="text-[10px] text-slate-500 dark:text-slate-400 block font-bold">تكلفة / صافي الربح:</span>
                      <div className="flex items-center gap-1.5 font-mono text-xs font-bold">
                        <span className="text-rose-700 dark:text-rose-400">{costVal.toLocaleString()}</span>
                        <span className="text-slate-400">/</span>
                        <span className="text-emerald-700 dark:text-emerald-400 font-black">+{profitVal.toLocaleString()}</span>
                      </div>
                  ...
                  {/* Action Buttons */}
                  <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 border-t lg:border-t-0 lg:border-r border-slate-200 dark:border-slate-800 pt-3 lg:pt-0 lg:pr-4 shrink-0">
                    
                    {/* Design Attachment Button */}
                    <button
                      type="button"
                      onClick={() => setSelectedOrderForDesign(order)}
                      className="glass-button flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-blue-700 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/50 border-blue-200 dark:border-blue-800 text-xs font-bold transition-all"
                    ...
                    <button
                      ...
                      className="glass-button flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-emerald-700 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950/50 border-emerald-200 dark:border-emerald-800 text-xs font-bold transition-all"
                    ...
                    <button
                      ...
                      className="glass-button flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl text-slate-800 dark:text-slate-200 hover:text-slate-900 dark:hover:text-white text-xs font-bold"
            ...
            {filteredOrders.length === 0 && (
              <div className="col-span-full glass-panel p-16 rounded-2xl text-center flex flex-col items-center justify-center gap-3">
                ...
                <div>
                  <h3 className="text-base font-bold text-slate-900 dark:text-white mb-1">لا توجد طلبيات مطابقة للبحث أو الفلتر</h3>
                  <p className="text-xs text-slate-500 dark:text-slate-400">جرب تغيير كلمات البحث أو اسم الزبون أو قم بإضافة طلبية جديدة من التبويب المخصص.</p>
                </div>
              </div>
            )}
          </div>
      ...
      {activeTab === 'kanban' && (
        <div className="space-y-5 animate-in fade-in duration-200">
          ...
          {/* Kanban Toolbar */}
          <div className="glass-panel p-4 rounded-2xl bg-white/90 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800 flex flex-col md:flex-row justify-between items-stretch md:items-center gap-3 no-print">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full glass-input rounded-xl pr-9 pl-4 py-2 text-xs"
              />
              {kanbanSearch && (
                <button 
                  type="button"
            ...
            <div className="flex flex-wrap items-center gap-2">
              <div className="relative">
                <select
                  ...
                  className="glass-input rounded-xl px-3 py-2 text-xs font-bold bg-white dark:bg-slate-800 appearance-none pr-3 pl-8 cursor-pointer"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4.5 items-start">
            {kanbanColumns.map((col) => {
              ...
              return (
                <div 
                  key={col.id}
                  className={`glass-panel rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 flex flex-col max-h-[calc(100vh-220px)] border-t-4 ${col.borderColor}`}
                >
                  {/* Column Header */}
                  ...
                  <div className="p-3 space-y-3 overflow-y-auto flex-1 max-h-[620px]">
                    {columnOrders.map((order) => {
                      ...
                      return (
                        <div
                          key={order.id}
                          className="p-4 rounded-xl bg-white dark:bg-slate-800/90 border border-slate-200/90 dark:border-slate-700/80 shadow-xs hover:shadow-md transition-all space-y-3"
                        >
                          {/* Serial & Service */}
                          <div className="flex items-center justify-between gap-2">
                            <span className="font-mono text-xs font-black text-slate-900 dark:text-white bg-slate-100 dark:bg-slate-700 px-2 py-0.5 rounded border border-slate-200 dark:border-slate-600">
                              #{orderSerial}
                            </span>
                          ...
                          <div className="flex flex-wrap gap-1.5 text-[10px] text-slate-500 dark:text-slate-400">
                            {order.dimensions?.width && order.dimensions?.height && (
                              <span className="bg-slate-100 dark:bg-slate-700 px-2 py-0.5 rounded font-mono font-bold text-slate-700 dark:text-slate-300">
                          ...
                          <div className="pt-2 border-t border-slate-100 dark:border-slate-700/80 flex items-center justify-between gap-2">
                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              <button
                                type="button"
                                onClick={() => setSelectedOrderForDesign(order)}
                                className="p-1.5 rounded-lg text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/60 border border-blue-200 dark:border-blue-800/80 transition-colors"
                              ...
                              {nextStatus && (
                                <button
                                  ...
                                  className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-[10px] font-bold transition-colors shadow-xs"
